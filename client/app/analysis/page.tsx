      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-[#0a0a0b] p-8">
        <div className="text-center space-y-6 max-w-sm">
           <div className="w-20 h-20 bg-[#ba9eff]/10 rounded-2xl flex items-center justify-center mx-auto border border-[#ba9eff]/20 animate-pulse">
              <BarChart2 className="text-[#ba9eff]" size={40} />
           </div>
           <div className="space-y-2">
              <h1 className="text-3xl font-black text-white tracking-tight italic uppercase">Engine Analysis</h1>
              <p className="text-slate-500 text-sm font-medium leading-relaxed">
                Our high-speed Stockfish engine cluster is being tuned for deeper evaluation metrics.
              </p>
           </div>
           <button 
